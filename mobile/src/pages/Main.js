...
const styles = StyleSheet.create({
    ...
    matchContainer: {
        // absoluteFillObject: position absolute + top, left, right e bottom
        ...StyleSheet.absoluteFillObject, 
        /*Os 3 pontos são para trazer todas as propriedades do objeto 
        absoluteFillObject para dentro do matchContainer*/
